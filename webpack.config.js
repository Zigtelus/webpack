...
module.exports = {
  ...
  output: {
    ...
    filename: 'bundle.js' //роутинг с :id будет работать корректно при обновлении страницы, только если использовать название, которое будет совпадать с название файла, которое указывается в корневом файла index.html
  },
  devServer: {
    port: 8091,
